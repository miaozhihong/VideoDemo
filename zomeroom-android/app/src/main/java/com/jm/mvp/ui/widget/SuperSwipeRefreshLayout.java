...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    private boolean unAbleDownRefresh;

    public boolean isUnAbleDownRefresh() {
        return unAbleDownRefresh;
    }

    public void setUnAbleDownRefresh(boolean unAbleDownRefresh) {
        this.unAbleDownRefresh = unAbleDownRefresh;
    }
    ...
    public void setHeaderView(View child) {
        ...
        RelativeLayout.LayoutParams layoutParams =
                new RelativeLayout.LayoutParams(mHeaderViewWidth, mHeaderViewHeight);
    ...
    public void setFooterView(View child) {
        ...
        RelativeLayout.LayoutParams layoutParams =
                new RelativeLayout.LayoutParams(mFooterViewWidth, mFooterViewHeight);
    ...
    private void createHeaderViewContainer() {
        RelativeLayout.LayoutParams layoutParams =
                new RelativeLayout.LayoutParams((int) (mHeaderViewHeight * 0.8),
    ...
    public boolean isChildScrollToBottom() {
        ...
        if (mTarget instanceof RecyclerView) {
            ...
            if (view != null) {
                int diff = (view.getBottom() - (nestedScrollView.getHeight()
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mIsBeingDragged) {
                    ...
                    float slingshotDist =
                            mUsingCustomStart ? mSpinnerFinalOffset - mOriginalOffsetTop
                                    : mSpinnerFinalOffset;
                    ...
                    int targetY =
                            mOriginalOffsetTop + (int) ((slingshotDist * dragPercent) + extraMove);
    ...
    private void animatorFooterToBottom(int start,
                                        final int end) {
