...
/**
 * 作者 Created by Administrator on 2018/8/31 12:01
 * 页面功能:
 */
public class RecyclerViewAdapter extends BaseRvAdapter<SeeListBean.DataBean.ListBean, SeeAdapter.SeeHolder> {

    private List<SeeListBean.DataBean.ListBean> mList;
    private int mType;

    public RecyclerViewAdapter(List<SeeListBean.DataBean.ListBean> infos, Context context, int type) {
        super(infos, context);
        mType = type;
    }
    ...
    @Override
    protected SeeAdapter.SeeHolder getHolder(View view) {
    ...
    @Override
    protected void convert(SeeAdapter.SeeHolder holder, final SeeListBean.DataBean.ListBean bean, int position) {
    ...
    public void setListener(SeeAdapter.ClickListener listener) {
        mListener = listener;
    }


    private SeeAdapter.ClickListener mListener;
