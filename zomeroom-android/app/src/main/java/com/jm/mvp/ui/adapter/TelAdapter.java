...
public class TelAdapter extends BaseRvAdapter<TelListBean.DataBean.ListBean, TelAdapter.TelHolder> {
    private List<TelListBean.DataBean.ListBean> mList;
    private int mType;

    public TelAdapter(List<TelListBean.DataBean.ListBean> list, Context context) {
        super(list, context);
    }

    public TelAdapter(List<TelListBean.DataBean.ListBean> infos, Context context, int type) {
        super(infos, context);
        mType = type;
    }
    ...
    @Override
    protected void convert(TelHolder holder, final TelListBean.DataBean.ListBean bean, final int position) {
